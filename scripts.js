...
// Initialize global data with sample data if localStorage is empty, using window globals
...
// Renamed loadData to avoid conflict with common.js
function initializeSampleData(callback) {
    ...
    console.log('  usersData:', window.usersData);
    console.log('  employeesData:', window.employeesData);
    console.log('  propertiesData:', window.propertiesData);
    console.log('  dispatchData:', window.dispatchData);
    console.log('  reportsData:', window.reportsData);
    console.log('  peopleData:', window.peopleData);
