...
let employeesData = [
    { name: 'JohnSmith', route: 'Route-1', schedule: { start: '2025-03-21T08:00:00', end: '2025-03-21T16:00:00' }, location: 'HQ', department: 'Managers', status: '10-8' },
    { name: 'SarahJones', route: '', schedule: { start: '2025-03-21T08:00:00', end: '2025-03-21T16:00:00' }, location: 'Dispatch Center', department: 'Dispatchers', status: '10-8' },
    { name: 'AlexReed', route: 'Route-2', schedule: { start: '2025-03-21T08:00:00', end: '2025-03-21T16:00:00' }, location: 'North Sector', department: 'Officers', status: '10-8' },
    { name: 'TomVega', route: 'Route-3', schedule: { start: '2025-03-21T08:00:00', end: '2025-03-21T16:00:00' }, location: 'South Sector', department: 'Supervisors', status: '10-8' },
    { name: 'BellaCruz', route: 'Route-4', schedule: { start: '2025-03-21T08:00:00', end: '2025-03-21T16:00:00' }, location: 'East Sector', department: 'Officers', status: '10-8' },
    { name: 'MikeBrown', route: 'Route-5', schedule: { start: '2025-03-21T08:00:00', end: '2025-03-21T16:00:00' }, location: 'West Sector', department: 'Officers', status: '10-8' },
    { name: 'LisaWhite', route: '', schedule: { start: '2025-03-21T08:00:00', end: '2025-03-21T16:00:00' }, location: 'Dispatch Center', department: 'Dispatchers', status: '10-8' },
    { name: 'JamesGreen', route: 'Route-1', schedule: { start: '2025-03-21T16:00:00', end: '2025-03-22T00:00:00' }, location: 'North Sector', department: 'Officers', status: '10-8' },
    { name: 'EmmaDavis', route: 'Route-2', schedule: { start: '2025-03-21T16:00:00', end: '2025-03-22T00:00:00' }, location: 'South Sector', department: 'Supervisors', status: '10-8' },
    { name: 'DavidLee', route: 'Route-3', schedule: { start: '2025-03-21T16:00:00', end: '2025-03-22T00:00:00' }, location: 'East Sector', department: 'Officers', status: '10-8' }
];
